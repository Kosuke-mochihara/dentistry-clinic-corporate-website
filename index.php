          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="p-top-mv__img">
                <picture>
                  <source media="(min-width: 768px)" srcset="../images/common/top-mv__img01-pc.jpg">
                  <img src="../images/common/top-mv__img01-sp.jpg" alt="スライダー画像01">
                </picture>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="p-top-mv__img">
                <picture>
                  <source media="(min-width: 768px)" srcset="../images/common/top-mv__img02-pc.jpg">
                  <img src="../images/common/top-mv__img02-sp.jpg" alt="スライダー画像01">
                </picture>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="p-top-mv__img">
                <picture>
                  <source media="(min-width: 768px)" srcset="../images/common/top-mv__img03-pc.jpg">
                  <img src="../images/common/top-mv__img03-sp.jpg" alt="スライダー画像01">
                </picture>
              </div>
            </div>
    ...
    <div class="p-top-news__inner l-inner">
      <div class="p-top-news__contents">
        ...
        <picture class="p-top-news__time-img">
          <source media="(min-width: 768px)" srcset="../images/common/medical-time-pc.png">
          <img src="../images/common/medical-time-sp.png" alt="診療時間" decoding="async">
        </picture>
      </div>
    </div>
  </section>
      ...
      <div class="p-top-concept__content-bg">
        <div class="p-top-concept__content">
          <div class="p-top-concept__img">
            <img src="../images/common/top-concept__img-sp.jpg" alt="歯科医の画像">
          </div>
      ...
      <ul class="p-top-about__items">
        <li class="p-top-about__item">
          <div class="p-top-about__header-img">
            <img src="../images/common/top-about__icon01.png" alt="おすすめの画像01">
          </div>
          <div class="p-top-about__body-img">
            <img src="../images/common/top-about__img01.png" alt="痛くない歯科医療の追求">
          </div>
        ...
        <li class="p-top-about__item">
          <div class="p-top-about__header-img">
            <img src="../images/common/top-about__icon02.png" alt="おすすめの画像02">
          </div>
          <div class="p-top-about__body-img">
            <img src="../images/common/top-about__img02.png" alt="駅から徒歩3分">
          </div>
          <p class="p-top-about__text">「通いやすさ」も医院選びの重要なポイントと考え、2019年のリニューアルを期に更に駅の近くへ場所を移しました。</p>
        </li>
        <li class="p-top-about__item">
          <div class="p-top-about__header-img">
            <img src="../images/common/top-about__icon03.png" alt="おすすめの画像03">
          </div>
          <div class="p-top-about__body-img">
            <img src="../images/common/top-about__img03.png" alt="夜20:30まで営業">
          </div>
