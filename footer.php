...
<!-- 共通パーツ -->
 <div class="l-footer-top p-footer-top"></div>
        ...
        <ul class="p-footer__nav-items">
          ...
          <li class="p-footer__nav-item">
            <div class="p-footer__nav-item-box">
              ...
              <div class="p-footer__nav-item-body">
                <a href="#"><span class="p-footer__icon"></span>ポリシーと特徴</a>
              </div>
              <div class="p-footer__nav-item-body">
                <a href="#"><span class="p-footer__icon"></span>当院の様子</a>
              </div>
            </div>
          </li>
          <li class="p-footer__nav-item">
            <div class="p-footer__nav-item-box">
              ...
              <div class="p-footer__nav-item-body">
                <a href="#"><span class="p-footer__icon"></span>院長のあいさつ</a>
              </div>
              <div class="p-footer__nav-item-body">
                <a href="#"><span class="p-footer__icon"></span>スタッフ</a>
              </div>
              <div class="p-footer__nav-item-body">
                <a href="#"><span class="p-footer__icon"></span>スタッフブログ</a>
              </div>
            </div>
          </li>
          <li class="p-footer__nav-item">
            <div class="p-footer__nav-item-box">
              ...
              <div class="p-footer__nav-item-content">
                <div class="p-footer__nav-item-body p-footer__nav-item-body--box">
                  <a href="#"><span class="p-footer__icon"></span>一般歯科</a>
                </div>
                <div class="p-footer__nav-item-body">
                  <a href="#"><span class="p-footer__icon"></span>矯正歯科</a>
                </div>
              </div>
              <div class="p-footer__nav-item-content">
                <div class="p-footer__nav-item-body p-footer__nav-item-body--box">
                  <a href="#"><span class="p-footer__icon"></span>小児歯科</a>
                </div>
                <div class="p-footer__nav-item-body">
                  <a href="#"><span class="p-footer__icon"></span>ホワイトニング</a>
                </div>
              </div>
              <div class="p-footer__nav-item-content">
                <div class="p-footer__nav-item-body p-footer__nav-item-body--box">
                  <a href="#"><span class="p-footer__icon"></span>予防歯科</a>
                </div>
                <div class="p-footer__nav-item-body">
                  <a href="#"><span class="p-footer__icon"></span>口腔外科</a>
                </div>
              </div>
              <div class="p-footer__nav-item-content">
                <div class="p-footer__nav-item-body p-footer__nav-item-body--box">
                  <a href="#"><span class="p-footer__icon"></span>入れ歯</a>
                </div>
                <div class="p-footer__nav-item-body">
                  <a href="#"><span class="p-footer__icon"></span>レーザー治療</a>
                </div>
              </div>
            </div>
          </li>
          <li class="p-footer__nav-item">
            <div class="p-footer__nav-item-box">
              ...
              <div class="p-footer__nav-item-body">
                <a href="page-contact.html"><span class="p-footer__icon"></span>お問い合わせフォーム</a>
              </div>
              <div class="p-footer__nav-item-body">
                <a href="page-reservation.html"><span class="p-footer__icon"></span>WEB予約</a>
              </div>
            </div>
          </li>
        </ul>
  ...
  <!-- 画面右追従 -->
  <a class="c-web-reservation-btn" href="page-reservation.html">
