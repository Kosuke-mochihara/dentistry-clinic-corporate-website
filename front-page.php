        ...
        <div class="p-top-concept__content-bg">
            <div class="p-top-concept__content js-slideIn">
                <div class="p-top-concept__img">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-concept__img-sp.jpg"
                        alt="歯科医の画像">
                </div>
...
<section class="l-top-about p-top-about">
    <div class="p-top-about__inner l-inner js-slideIn">
        ...
        <ul class="p-top-about__items js-about-trigger">
            <li class="p-top-about__item js-about">
                ...
                <div class="p-top-about__body-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-about__img01.png"
                        alt="痛くない歯科医療の追求">
                </div>
            ...
            <li class="p-top-about__item js-about">
                ...
                <div class="p-top-about__body-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-about__img02.png"
                        alt="駅から徒歩3分">
                </div>
            ...
            <li class="p-top-about__item js-about">
                ...
                <div class="p-top-about__body-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-about__img03.png"
                        alt="夜20:30まで営業">
                </div>
...
<section class="p-top-guidance">
    <div class="p-top-guidance__inner l-inner js-slideIn">
        <div class="section__box">
        ...
        <div class="p-top-guidance__content">
            <p class="p-top-guidance__content-text">当院では、患者さんの歯の健康状態や治療方針を丁寧にカウンセリングし、十分ご理解していただいた上で治療いたします。<br>
                痛みに配慮することと、可能な限り削らない・抜かない治療に努めております。<br><span>※特殊性の高い矯正治療などは保険の適応外となります。
...
<section class="l-top-blog p-top-blog">
    <div class="p-top-blog__inner l-inner js-slideIn">
        <div class="section__box">
